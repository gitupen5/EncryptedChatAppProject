...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtn = findViewById(R.id.buttenRegister);

        //FirebaseAuth
        auth = FirebaseAuth.getInstance();

        //Adding event listeners to buttonRegister.
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            hashMap.put("imageURL", "default"); //profile
                            hashMap.put("status", "offline"); //status

                            //opening the main activity after successful login.
